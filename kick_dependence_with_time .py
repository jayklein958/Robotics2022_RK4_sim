...
def main(t2a,time):
    """Function that sets up the initial conditions of the double pendulum,
    then applies a Centre of mass shift at time t, the function then outputs
    the ratio of the final amplitude/initial amplitude"""
    dt = 1/1000
    g = -9.81
    m1 = 0.762
    m2 = 8.891
...
def ratio(time,y):
    """Function that calculates the amplitude of a sin wave before and after 
    a centre of mass shift"""
